...
export class Politica_Cookie extends Component {
	render() {
		return (
			<div className="continut">
				<div className="titlu">
					<h1>Politica privind fișierele cookies</h1>
				</div>

				<div className="capitol">
					<h3>I. Introducere</h3>
					<p>Prezenta Politică privind fișierele cookies se aplică tuturor utilizatorilor paginii de internet www.handcrafted-leather.com. Informațiile prezentate în continuare au ca scop informarea utilizatorilor acestei pagini de internet cu privire la plasarea, utilizarea și administrarea cookie-urilor de către Marian Mihalache în contextul navigării utilizatorilor pe această pagină de internet.
            </p>
				</div>

				<div className="capitol">
					<h3>II. Ce sunt cookie-urile?</h3>
				...
				<div className="capitol">
					<h3>III. Pentru ce scopuri sunt utilizate cookie-urile prin intermediul acestei pagini de internet:</h3>
					<p>Cookie-urile sunt utilizate pentru a furniza utilizatorilor acestei pagini de internet o experiență mai bună de navigare și servicii adaptate nevoilor și interesului fiecărui utilizator în parte și anume pentru:
				</p>
					...
					<ul>
						...
						<li>furnizarea de statistici anonime cu privire la modul în care este utilizată această pagină de internet către [deținătorul website-ului], în calitate de deținător al acestei pagini de internet;</li>
					...
					<p>
						Pe baza feedback-ului transmis prin cookie-uri în legătură cu modul în care se utilizează această pagină de internet, [deținătorul website-ului] poate adopta măsuri pentru ca această pagină de internet să fie mai eficientă și mai accesibilă pentru utilizatori.
				...
				<div className="capitol">
					<h3>IV. Care este durata de viață a cookie-urilor?</h3>
					<p>Durata de viață a cookie-urilor poate varia semnificativ, depinzând de scopul pentru care este plasat. Există următoarele categorii de cookie-uri care determină și durata de viață a acestora:
				</p>
					<ul>
				...
				<div className="capitol">
					<h3>V. Ce sunt cookie-urile plasate de terți?</h3>
					<p>Anumite secțiuni de conținut de pe pagina de internet pot fi furnizate prin intermediul unor terți, adică nu de către Ionuț Prilipceanu, caz în care aceste cookie-uri sunt denumite cookie-uri plasate de terți („third party cookie-uri”).Terții furnizori ai cookie-urilor trebuie să respecte, de asemenea, regulile în materie de protecție a datelor și Politica de Confidențialitate disponibilă pe această pagină de internet.<br></br>
			Aceste cookie-uri pot proveni de la urmatorii terți: Google Analytics, Facebook.
			</p>
				</div>

				<div className="capitol">
					<h3>VI. Ce cookie-uri sunt folosite prin intermediul acestei pagini de internet:</h3>
				...
				<div className="capitol">
					<h3>VII. Ce tip de informații sunt stocate și accesate prin intermediul cookie-urilor?</h3>
					<p>Cookie-urile păstrează informații într-un fișier text de mici dimensiuni care permit recunoașterea browserului. Această pagină de internet recunoaște browserul până când cookie-urile expiră sau sunt șterse.
				</p>
				</div>

				<div className="capitol">
					<h3>VIII. Particularizarea setările browserului în ceea ce privește cookie-urile.</h3>
					<p>În cazul în care utilizarea cookie-urilor nu este deranjantă iar calculatorul sau echipamentul tehnic utilizat pentru navigarea pe această pagină de internet este folosit doar de către dumneavoastră, pot fi setate termene lungi de expirare pentru stocrarea istoricului de navigare.
				...
				<div className="capitol">
					<h3>IX. Cum pot fi oprite cookie-urile?</h3>
					<p>Dezactivarea și refuzul de a primi cookie-uri pot face această pagină de internet dificil de vizitat, atrăgând după sine limitări ale posibilităților de utilizare ale acesteia.
				...
				Totuși, refuzarea sau dezactivarea cookie-urilor nu înseamnă că nu veți mai primi publicitate online – ci doar ca aceasta nu va fi adaptată preferințelor și interesele dumneavoastră, evidențiate prin comportamentul de navigare.</p>
					...
					<ul className="setari">
						<li><a href="https://support.microsoft.com/ro-ro/help/17442/windows-internet-explorer-delete-manage-cookies" target="_blank" rel="noreferrer">Setari Cookie pentru Internet Explorer</a></li>
						<li><a href="https://support.mozilla.org/ro/kb/activarea-si-dezactivarea-cookie-urilor" target="_blank" rel="noreferrer">Setări Cookie pentru Firefox</a></li>
						<li><a href="https://support.google.com/chrome/answer/95647?co=GENIE.Platform%3DDesktop&hl=ro" target="_blank" rel="noreferrer">Setări Cookie pentru Chrome</a></li>
						<li><a href="https://support.apple.com/ro-ro/guide/safari/sfri11471/mac" target="_blank" rel="noreferrer">Setări Cookie pentru Safari</a></li>
					</ul>
				</div>
			</div>
		)
...
export default Politica_Cookie;
