	...
	<div className="titlu">
		...
		<div className="capitol">
			<h3>I. Introduction</h3>
				...
				<ul>
					...
					<li>Seller - Marian Mihalache Individual Enterprise, having a working point in Iași County;</li>
		...
		<div className="capitol">
			<h3>XVII. Processing of personal data</h3>
				...
				<p>
				XVII-I. Marian Mihalache - Handcrafted leather (www.handcrafted-leather.com), having its professional headquarters in Iaşi County.
				</p>
